  ...
  public class CMAPFrame : NitroFileFrameBase
  {
    ...
    public ushort this[char cValue]
    {
      ...
      set
      {
        ...
        {
          if ((int) cValue < (int)m_cFirstValue || (int) cValue > (int)m_cLastValue)
            return;
                    m_dicushushIndexes[cValue] = value;
        }
      }
    ...
    protected override byte[] GetContent()
    {
      ...
      switch (m_unType)
      {
        case 0:
          ...
          break;
        case 1:
          for (char cFirstValue = m_cFirstValue; (int) cFirstValue <= (int)m_cLastValue; ++cFirstValue)
    ...
    protected override void SetContent(byte[] arrbContent)
    {
      ...
      if ((int)m_cFirstValue > (int)m_cLastValue)
        throw new FormatException();
      ...
      switch (m_unType)
      {
        case 0:
          ...
          if ((int) num1 - (int)m_cFirstValue + (int)m_cLastValue > (int) ushort.MaxValue)
            throw new FormatException();
          for (char cFirstValue = m_cFirstValue; (int) cFirstValue <= (int)m_cLastValue; ++cFirstValue)
          {
          ...
          break;
        case 1:
          int num2 = 12 + 2 * ((int)m_cLastValue - (int)m_cFirstValue + 1);
    ...
    public bool ContainsValue(char cValue)
    {
      ...
      if ((int) cValue >= (int)m_cFirstValue)
        return (int) cValue <= (int)m_cLastValue;
      return false;
    }
    ...
    {
      int index1 = 3;
      while (index1 < (int) nftrNitro.FramesCount - 1 && nftrNitro.Frames[index1] != this)
        ++index1;
      if (index1 == (int) nftrNitro.FramesCount - 1)
        return;
      uint size = (uint)Size;
      ...
      for (int index2 = index1 + 1; index2 < (int) nftrNitro.FramesCount; ++index2)
      {
