        ...
        private class Pallete
        {
            ...
            public Pallete(BinaryReader brrReader)
            {
                ...
                for (int index1 = 0; index1 < 8; ++index1)
                {
                    ...
                    for (int index2 = 7; index2 >= 0; --index2)
                    {
                        m_arrvValues[index1, index2] = (VALUE)((int)num & 3);
                        num /= (ushort)4;
                    }
                }
            }
            ...
            public void WriteTo(BinaryWriter brwWriter)
            {
                for (int index1 = 0; index1 < 8; ++index1)
                {
                    ushort num = (ushort)(byte)m_arrvValues[index1, 0];
                    for (int index2 = 1; index2 < 8; ++index2)
                        num = (ushort)((uint)(ushort)((uint)num * 4U) + (uint)(byte)m_arrvValues[index1, index2]);
                    brwWriter.Write(num);
                }
            }
        }
